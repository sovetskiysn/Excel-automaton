Проект представляет собой windows application написанный на tkinter. На вход он программа принимает Excel файлы, проводит над ними какую-то обработку и возвращает обработанный вариант.
